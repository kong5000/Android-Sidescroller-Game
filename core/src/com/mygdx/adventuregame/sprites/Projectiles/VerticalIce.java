...
public class VerticalIce extends Sprite implements UpdatableSprite, EnemyProjectile {
    ...
    public VerticalIce(PlayScreen screen, float x, float y){
        ...
        stateTimer = 0;
        projectileAnimation = generateAnimation(screen.getAtlas().findRegion("water_projectile")
    ...
    public void update(float dt){
        ...
        setPosition(b2body.getPosition().x + 0.08f, b2body.getPosition().y - getHeight() / 2);
    ...
    public void explode(){
        screen.getSpritesToAdd().add(new IceShatter(screen, getX() -  0.55f
