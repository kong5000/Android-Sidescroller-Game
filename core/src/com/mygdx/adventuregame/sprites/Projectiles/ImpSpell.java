...
public class ImpSpell extends Sprite implements UpdatableSprite, EnemyProjectile {
    ...
    private static final int HEIGHT_PIXELS = 9;
    private boolean isFriendly;

    private Animation<TextureRegion> projectile;

    public ImpSpell(PlayScreen screen, float x, float y, boolean goingRight, boolean isFriendly) {
        ...
        stateTimer = 0;
        projectileAnimation = generateAnimation(screen.getAtlas().findRegion("imp_projectile")
