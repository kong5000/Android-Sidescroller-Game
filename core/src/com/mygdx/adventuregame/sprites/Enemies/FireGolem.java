...
public class FireGolem extends Enemy {
    ...
    public FireGolem(PlayScreen screen, float x, float y) {
        ...
        fastAttackAnimation = generateAnimation(screen.getAtlas().findRegion("fire_golem_launch_ball"),
                5, WIDTH_PIXELS, HEIGHT_PIXELS, 0.12f);
        fastAttackAnimationDamaged = generateAnimation(screen.getAtlas().findRegion("fire_golem_launch_ball"),
                5, WIDTH_PIXELS, HEIGHT_PIXELS, 0.12f);
        ...
        jumpAnimation = generateAnimation(screen.getAtlas().findRegion("fire_golem_jump"),
...
//        b2body.setLinearVelocity(-1.1f, b2body.getLinearVelocity().y);
    ...
    private void launchProjectiles() {
        for (float i : projectileCoords) {
            VerticalFireBall fireBall = new VerticalFireBall(screen, i, getY() + getHeight() / 2 + 2.5f);
